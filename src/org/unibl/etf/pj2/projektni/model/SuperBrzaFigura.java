...
public class SuperBrzaFigura extends Figura implements NacinKretanja {
    Rectangle rectangle = new Rectangle();
    List<Pane> paneList = new ArrayList<>();
    int dimenzijaMatrice;
    Pane[][] orginalPanes;

    public SuperBrzaFigura() {
        super();
    }
    public SuperBrzaFigura(String boja, Pane[][] panes, int dimenzijaMatrice) {
        super(boja);
        ...
        if(boja.equals("crvena")) rectangle.setFill(Color.RED);
        else if(boja.equals("plava")) rectangle.setFill(Color.BLUE);
        else if(boja.equals("zelena")) rectangle.setFill(Color.GREEN);
        else rectangle.setFill(Color.YELLOW);
    }
    ...
    @Override
    public void run() {
        System.out.println(dimenzijaMatrice);
